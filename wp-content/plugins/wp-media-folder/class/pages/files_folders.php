<div class="content-box content-wpmf-files-folders">
        ...
        <div class="wpmf_row_full">
            ...
            <div class="wrap_remove_character">
                ...
                <div class="pure-checkbox">
                    ...
                    <input id="wpmf_hash" type="checkbox" name="wpmf_options_format_title[hash]" <?php checked($opts_format_title['hash'],1) ?> value="1">
                    <label for="wpmf_hash"><?php _e('Hash/pound','wpmf') ?> #</label>
                </div>

                <div class="pure-checkbox">
                    <input type="hidden" name="wpmf_options_format_title[ampersand]" value="0">
                    <input id="wpmf_ampersand" type="checkbox" name="wpmf_options_format_title[ampersand]" <?php checked($opts_format_title['ampersand'],1) ?> value="1">
                    <label for="wpmf_ampersand"><?php _e('Ampersand','wpmf') ?> @</label>
                </div>

                <div class="pure-checkbox">
                    <input type="hidden" name="wpmf_options_format_title[number]" value="0">
                    <input id="wpmf_number" type="checkbox" name="wpmf_options_format_title[number]" <?php checked($opts_format_title['number'],1) ?> value="1">
                ...
                <div class="pure-checkbox">
                    ...
                    <input id="wpmf_square_brackets" type="checkbox" name="wpmf_options_format_title[square_brackets]" <?php checked($opts_format_title['square_brackets'],1) ?> value="1">
                ...
                <div class="pure-checkbox">
                    ...
                    <input id="wpmf_round_brackets" type="checkbox" name="wpmf_options_format_title[round_brackets]" <?php checked($opts_format_title['round_brackets'],1) ?> value="1">
                ...
                <div class="pure-checkbox">
                    ...
                    <input id="wpmf_curly_brackets" type="checkbox" name="wpmf_options_format_title[curly_brackets]" <?php checked($opts_format_title['curly_brackets'],1) ?> value="1">
    ...
    <div class="cboption">
        ...
        <div class="wpmf_row_full">
            ...
            <label alt="<?php _e('Watermark will be applied only after saving the settings and regenerate the thumnails (hit the "regenerate thumnails" button)', 'wpmf'); ?>" class="text"><?php _e('Images watermark', 'wpmf') ?></label>
            <div class="switch-optimization">
                <label class="switch switch-optimization">
                    <input type="checkbox" id="cb_option_image_watermark" name="wpmf_option_image_watermark" value="1" <?php if (isset($option_image_watermark) && $option_image_watermark == 1) echo 'checked' ?>>
                    <div class="slider round"></div>
                </label>
            </div>
        </div>
    ...
    <div class="cboption">
        <div class="wpmf_row_full">
            <label alt="<?php _e('Select an image', 'wpmf') ?>" class="text"><?php _e('Select an image', 'wpmf') ?></label>
            <input type="text" readonly name="wpmf_watermark_image" id="wpmf_watermark_image" class="regular-text" value="<?php echo $watermark_image; ?>">
            <input type="hidden" name="wpmf_watermark_image_id" id="wpmf_watermark_image_id" class="regular-text" value="<?php echo $watermark_image_id; ?>">
    ...
    <div class="cboption">
        <div class="wpmf_row_full">
            <label alt="<?php _e('Watermark position', 'wpmf'); ?>" class="text"><?php _e('Watermark position', 'wpmf') ?></label>
            <select name="wpmf_watermark_position">
                <option <?php selected($watermark_position, 'center'); ?> value="center"><?php _e('Center', 'wpmf') ?></option>
                <option <?php selected($watermark_position, 'bottom_left'); ?> value="bottom_left"><?php _e('Bottom Left', 'wpmf') ?></option>
                <option <?php selected($watermark_position, 'bottom_right'); ?> value="bottom_right"><?php _e('Bottom Right', 'wpmf') ?></option>
                <option <?php selected($watermark_position, 'top_right'); ?> value="top_right"><?php _e('Top Right', 'wpmf') ?></option>
                <option <?php selected($watermark_position, 'top_left'); ?> value="top_left"><?php _e('Top Left', 'wpmf') ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="cboption">
        <div class="wpmf_row_full">
            <label alt="<?php _e('Apply watermark on', 'wpmf'); ?>" class="text"><?php _e('Apply watermark on', 'wpmf') ?></label>
            <div class="wrap_apply">
                <div class="pure-checkbox">
                    <input type="hidden" name="wpmf_image_watermark_apply[all_size]" value="0">
                    <input id="wpmf_watermark_position_all" type="checkbox" name="wpmf_image_watermark_apply[all_size]" <?php checked($watermark_apply['all_size'],1) ?> value="1">
                ...
                foreach ($sizes as $ksize => $vsize):
                    ...
                    <div class="pure-checkbox">
                        ...
                        <input id="wpmf_watermark_position_<?php echo $ksize ?>" type="checkbox" name="wpmf_image_watermark_apply[<?php echo $ksize ?>]" checked value="1">
                        <?php else: ?>
                        <input id="wpmf_watermark_position_<?php echo $ksize ?>" type="checkbox" name="wpmf_image_watermark_apply[<?php echo $ksize ?>]" value="1">
                        <?php endif; ?>
    ...
    <div class="cboption">
        <div class="wpmf_row_full">
            ...
            <div class="button wpmf_watermark_regeneration" data-paged="1"><?php _e('Thumbnail regeneration','wpmf') ?></div>
