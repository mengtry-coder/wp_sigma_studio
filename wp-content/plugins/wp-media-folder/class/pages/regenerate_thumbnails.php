<div class="content-box content-wpmf-regen-thumbnail">
    <div class="btnoption">
        ...
        <input type="button" class="btn waves-effect waves-light waves-input-wrapper btn_regenerate_thumbnails stop" data-paged="1" value="<?php _e('Regenerate all image thumbnails', 'wpmf') ?>">
        <input type="button" class="btn waves-effect waves-light waves-input-wrapper btn_stop_regenerate_thumbnails" value="<?php _e('Stop the process', 'wpmf') ?>">
