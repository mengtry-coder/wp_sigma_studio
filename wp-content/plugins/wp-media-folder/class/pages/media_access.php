<div class="content-box content-wpmf-media-access">
    <div class="cboption">
        <div class="wpmf_row_full">
            ...
            <label alt="<?php _e('Once user upload some media, he will have a personal folder, can be per User or per User Role', 'wpmf'); ?>" class="text"><?php _e('Media access by User or User Role', 'wpmf') ?></label>
        ...
        <div class="wpmf_row_full">
            <label alt="<?php _e('Select the root folder to store all user media and folders (only if Media by User or User Role is activated above)', 'wpmf'); ?>" class="text"><?php _e('User media folder root', 'wpmf') ?></label>
        </div>
        <div class="wpmf_row_full">
