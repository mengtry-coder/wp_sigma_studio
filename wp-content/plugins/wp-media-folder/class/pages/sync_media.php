<div class="content-box content-wpmf-media-sync">
    <div class="btnoption">
        <div class="wpmf_row_full">
            ...
            <label alt="<?php _e('Activate the sync from External folder to WordPress media library','wpmf') ?>" class="text"><?php _e('Activate the sync', 'wpmf') ?></label>
            <div class="switch-optimization">
                <label class="switch switch-optimization">
                    <input type="checkbox" id="cb_option_sync_media" name="wpmf_option_sync_media" value="1" <?php if (isset($option_sync_media) && $option_sync_media == 1) echo 'checked' ?>>
        ...
        <div class="wpmf_row_full">
            ...
            <label alt="<?php _e('Also activate the sync from WordPress media library to external folders','wpmf') ?>" class="text"><?php _e('Activate 2 ways sync', 'wpmf') ?></label>
            <div class="switch-optimization">
                <label class="switch switch-optimization">
                    <input type="checkbox" id="cb_option_sync_media_external" name="wpmf_option_sync_media_external" value="1" <?php if (isset($option_sync_media_external) && $option_sync_media_external == 1) echo 'checked' ?>>
                    <div class="slider round"></div>
                </label>
            </div>
        </div>
