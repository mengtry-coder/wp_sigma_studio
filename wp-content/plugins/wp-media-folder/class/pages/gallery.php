<div class="content-box usegellery content-wpmf-gallery">
    <div class="cboption" >
        <div class="wpmf_row_full">
            ...
            <label alt="<?php _e('Enhance the WordPress default gallery system by adding themes and additional parameters in the gallery manager', 'wpmf'); ?>" class="text"><?php _e('Enable the gallery feature', 'wpmf') ?></label>
            <div class="switch-optimization">
                <label class="switch switch-optimization">
                    <input type="checkbox" name="wpmf_usegellery" value="1" <?php if (isset($usegellery) && $usegellery == 1) echo 'checked' ?>>
    ...
    <div class="cboption" >
        <div class="wpmf_row_full">
            ...
            <label alt="<?php _e('Enhance/Disable gallery lightbox', 'wpmf'); ?>" class="text"><?php _e('Enable the gallery lightbox feature', 'wpmf') ?></label>
            <div class="switch-optimization">
                <label class="switch switch-optimization">
                    <input type="checkbox" name="wpmf_usegellery_lightbox" value="1" <?php if (isset($option_usegellery_lightbox) && $option_usegellery_lightbox == 1) echo 'checked' ?>>
                    <div class="slider round"></div>
                </label>
            </div>
        </div>
    ...
    <div class="cboption" >
        ...
        <p>
            <div class="wpmfcard">
                <label class="radio">
                    <input id="radio1" type="radio" name="wpmf_slider_animation" value="slide" <?php checked($slider_animation, 'slide') ?>>
                    <span class="outer"><span class="inner"></span></span><?php _e('Slide', 'wpmf'); ?></label>
                <label class="radio">
                    <input id="radio2" type="radio" name="wpmf_slider_animation" value="fade" <?php checked($slider_animation, 'fade') ?>>
                        ...
                        foreach ($sizes as $key => $size):
                            ...
                            <li class="customize-control customize-control-select" style="display: list-item;">
                                <div class="pure-checkbox">
                                    <input id="<?php echo $key ?>" type="checkbox" name="size_value[]" value="<?php echo $key ?>" <?php if (in_array($key, $size_selected)) echo 'checked' ?>>
    ...
    <?php if (current_user_can('manage_options')): ?>
        <div class="cboption">
            <input type="button" id="btn_import_gallery" class="btn waves-effect waves-light waves-input-wrapper btn_import_gallery button-primary" value="<?php _e('Sync/Import NextGEN galleries', 'wpmf'); ?>">
