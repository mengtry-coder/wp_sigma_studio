...
foreach ($attachments as $id => $attachment) {
    ...
    if ($customlink) {
        ...
        $icon = "<a href='$url_image' title='$post_title' class='hover_img $tclass' target='$link_target'></a><a class='portfolio_lightbox $tclass' href='$url_image' title='$post_title' target='$link_target'>+</a>";
        if ($url_image == '')
            $url_image = get_attachment_link($id);
        ...
        if (strpos($image_output, "data-lightbox='0'")) {
            $url_image = get_post_meta($id, _WPMF_GALLERY_PREFIX . 'custom_image_link', true);
            $icon = "<a data-lightbox='0' href='$url_image' title='$post_title' class='hover_img $tclass' target='$link_target'></a><a data-lightbox='0' class='portfolio_lightbox $tclass' href='$url_image' title='$post_title' target='$link_target'>+</a>";
        } else {
            $urls = wp_get_attachment_image_src($id, $targetsize);
            $url_image = $urls[0];
            //$url_image = wp_get_attachment_url($id);
            if(!empty($remote_video)){
                $icon = "<a data-lightbox='1' href='$remote_video' title='$post_title' class='hover_img $tclass isvideo'></a><a data-lightbox='1' class='portfolio_lightbox $tclass isvideo' href='$remote_video' title='$post_title'>+</a>";
            }else{
                $icon = "<a data-lightbox='1' href='$url_image' title='$post_title' class='hover_img $tclass not_video'></a><a data-lightbox='1' class='portfolio_lightbox $tclass not_video' href='$url_image' title='$post_title'>+</a>";
            }
        }
