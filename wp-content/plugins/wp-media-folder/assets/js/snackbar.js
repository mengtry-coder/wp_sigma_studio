...
(function (factory) {
    ...
    /*$(document).on("click", "#snackbar-container .snackbar .wpmf_do_undo", function() {
            $(this).snackbar("hide");
        });*/
    ...
    $.snackbar = function (options) {
        if (isset(options) && options === Object(options)) {
            ...
            if (isset(options.wpmftype)) {
                $snackbar.attr("data-wpmftype", options.wpmftype);
            }
            ...
            if (isset(options.content)) {
                if ($snackbar.find(".snackbar-content").length) {
                    ...
                    if(typeof options.wpmftype == "undefined"){
                        $snackbar.prepend("<span class='snackbar-content wpmf-snackbar-content'>" + options.content + "<a class='wpmf_do_undo'>UNDO</a></span><i class='material-icons wpmf-material-icons-clear'>clear</i>");

                    }else{
                        if(options.wpmftype == 'undo'){
                            $snackbar.prepend("<span class='snackbar-content wpmf-snackbar-content'>" + options.content + "<a class='wpmf_do_undo'>UNDO</a></span><i class='material-icons wpmf-material-icons-clear'>clear</i>");
                        }else if(options.wpmftype == 'fileupload'){
                            $snackbar.prepend("<span class='snackbar-content wpmf-snackbar-content'>" + options.content + "</span><i class='material-icons wpmf-material-icons-clear'>clear</i>");
                            $snackbar.append('<div class="linear-activity wpmfliner_progress"> <div class="indeterminate"></div> </div>');
                        }else{
                            $snackbar.prepend("<span class='snackbar-content wpmf-snackbar-content'>" + options.content + "</span><i class='material-icons wpmf-material-icons-clear'>clear</i>");
                        }
        ...
        if (!this.hasClass("snackbar")) {
            ...
            if (!isset(action) || action === "show" || action === "hide" || action == "toggle") {
                options = {
                    ...
                    wpmftype: $(this).attr("data-wpmftype")
                };
            }
